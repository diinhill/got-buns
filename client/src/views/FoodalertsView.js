...
const FoodalertsView = () => {
    ...
    useEffect(() => {
        const getFoodalerts = async () => {
            const res = await axios.get('http://localhost:5000/api/foodalerts/')
    ...
    return (
        ...
        <Container>
            <Typography variant='h2' color='default' component='h4' align='center'>foodalerts</Typography>
